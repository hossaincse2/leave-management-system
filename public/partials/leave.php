...
<div class="container" style="margin-top:100px">
  ...
  <div class="col-md-9 leave_section"> 
    ...
    <div class="card">
    <div class="leaveDetails" style="<?php echo isset($leaveId) ?  'display:block' : 'display:none'   ?>">
    <div class="card-header">
         <span><img style="width: 16px;" src="<?php  echo plugin_dir_url( dirname( __FILE__ ) ) . '/img/details.svg'; ?>" alt=""> Details leave</span> 
        ...
        <div class="card-body"> 
            <div class="row">
              <div class="col-md-6">
                <b>leave ID:</b> <span>#NS00<?php echo isset($details[0]->id) ?  $details[0]->id : ''  ?></span> <br>
                <b>leave Name:</b> <span><?php echo  isset($details[0]->leave_name) ?  $details[0]->leave_name : '' ?></span> <br> 
                <b>leave Description:</b> <span><?php echo  isset($details[0]->leave_description) ?  $details[0]->leave_description : '' ?></span> <br> 
              </div>
              <div class="col-md-6">
                <a class="float-right" href="leave_edit?leave-id=<?php echo  isset($details[0]->id) ?  $details[0]->id : '' ?>"><img style="width: 16px;" src="<?php  echo plugin_dir_url( dirname( __FILE__ ) ) . '/img/edit.svg'; ?>" alt=""> Edit</a>
        ...
        <div class="leaveForm" style="<?php echo isset($leaveId) ?  'display:none' : 'display:block'   ?>">
        <div class="card-header">
         <span><img style="width: 16px;" src="<?php  echo plugin_dir_url( dirname( __FILE__ ) ) . '/img/add.svg'; ?>" alt=""> Create leave</span> 
         <ul class="list-inline listMenu">
        ...
        <form  class="pb-4" action="" s>
          ...
          <div class="col-md-12  text-right p0">
             <button type="submit" id="leaveInsert" class="btn btn-primary">Create</button>
          </div>
        </form>
        </div>
        </div>
    ...
    <div class="card">
        <div class="card-header">
          ...
          <ul class="list-inline listMenu">
            ...
            <li class="list-inline-item"><a id="leave_clone" data-id = "<?php echo isset($_GET['leave-id']) ? $_GET['leave-id'] : '';  ?>" class="social-icon text-xs-center" target="_blank" href="#"><img style="width: 15px;" src="<?php  echo plugin_dir_url( dirname( __FILE__ ) ) . '/img/clone.svg'; ?>" alt=""> Clone</a></li>
