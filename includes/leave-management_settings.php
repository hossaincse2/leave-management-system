...
class Leave_Settings {

	protected $delete_time;
	protected $notification_menu;
	protected $shortcode;
	protected $leave_menu;
	protected $leave_limit;
	...
	public static function register_settings_optings() {
		register_setting( 'get_leave_settings_group', 'delete_time' );
		register_setting( 'get_leave_settings_group', 'leave_menu' );
		register_setting( 'get_leave_settings_group', 'per_page' );
 	    register_setting( 'get_leave_settings_group', 'primary_color' );
 	    register_setting( 'get_leave_settings_group', 'seccondary_color' );
 	    register_setting( 'get_leave_settings_group', 'button_color' );
 	    register_setting( 'get_leave_settings_group', 'hover_color' );
 	    register_setting( 'get_leave_settings_group', 'leave_limit' );
 	    register_setting( 'get_leave_settings_group', 'leave_export_footer' );
 	    register_setting( 'get_leave_settings_group', 'company_name' );
 	    register_setting( 'get_leave_settings_group', 'leave_category1' );
 	    register_setting( 'get_leave_settings_group', 'leave_category2' );
		return true;
	}
